" Test on Sample 1, go inside block and :norm vGird, repeat upwards.
...
26
normal 0vGird
call vimtap#Is(getline(1,line('$')), ['" Sample 1', 'function Test()', 'endfunction'], 'Check if the selection was correct.')
undo
26
normal 0vggird
